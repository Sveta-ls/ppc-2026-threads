...
void MulBlock(const std::vector<double>& a,
...
void RegularMultiplication(const std::vector<double>& a,
                           const std::vector<double>& b,
                           std::vector<double>& c,
                           int n) {
  auto idx = MakeIdx(n);
...
void InitializeBlocks(const std::vector<double>& a,
                      const std::vector<double>& b,
...
void AlignBlocks(const std::vector<std::vector<double>>& ba,
...
void CannonStep(std::vector<std::vector<double>>& a,
...
void Assemble(const std::vector<std::vector<double>>& c,
              std::vector<double>& r,
              int g, int bs, int n) {
